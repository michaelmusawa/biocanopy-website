...
const Services = () => {
  return (
    <PortfolioUi
      ...
      Offices experience downtime when searching for documents and security is a concern. Let all that be our worry!s.'
      content2='Printer fleet management means your employees aren&apost; clearing jams, refilling paper or replacing toner. Instead, a person is on-site maintaining any and all print devices. They’re the first call for support. That person is trained on how to fix the little issues that arise and place service calls as needed. This means true proactive support, cleaning the device on schedule and stocking paper before it runs out.'
